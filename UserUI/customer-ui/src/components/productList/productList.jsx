        ...
        <Fragment>
            ...
            <header>
                ...
                <main style={{ minHeight: '100vh', backgroundColor: 'rgb(234, 227, 219)' }} data-bs-spy="scroll"
                    ...
                    <div class="content trang1">

                        <div class="row container">
                            <div class="col-6 content-left">
                                <img src="https://encrypted-tbn1.gstatic.com/shopping?q=tbn:ANd9GcRlpywq2VT31lrqPZ9dhn_zsqqSizsC2hyb4D-fT7dEbqvNx6k1DOjQf1gpAcUGKBjXhDDRSXvftioHr08QUJm5ApgRKhG3XghYuahoIe0&usqp=CAE"
                                    class="img-fluid ${3|rounded-top,rounded-right,rounded-bottom,rounded-left,rounded-circle,|}"
                                    alt="" />
                            </div>
                            <div class="col-6 content-right">
                                <h1 class="font-monospace"><strong>CHÀO MỪNG BẠN ĐẾN VỚI 404SHOES</strong></h1>
                                <hr />
                                <p class="font-monospace">Chào mừng bạn đến với trang web của chúng tôi, nơi bạn có thể khám phá và mua sắm đa dạng các sản phẩm giày thể thao chất lượng. Với sự đa dạng về kiểu dáng, chất liệu và thương hiệu, chúng tôi cam kết mang đến cho bạn trải nghiệm mua sắm tốt nhất. Tại đây, bạn sẽ tìm thấy giày thể thao phù hợp với mọi hoạt động, từ chạy bộ đến bóng đá, bóng rổ, và nhiều môn thể thao khác. Bất kể bạn là người yêu thể thao chuyên nghiệp hay đang tìm kiếm sự thoải mái cho cuộc sống hàng ngày, chúng tôi có sản phẩm phù hợp với bạn. Hãy khám phá danh mục sản phẩm của chúng tôi và cùng trang bị cho mình những đôi giày thể thao xuất sắc!</p>

                                <div class="d-flex justify-content-center">

                                    <button class="btn btn-outline-success mt-3" id="learnMore">Xem Thêm</button>
                                </div>
                            </div>
                    ...
                    <div class="content trang2" id="div1">
                        <div class="row container">
                                        ...
                                        <div class="card text-start ">
                                            <div class="position-relative">
                                                ...
                                                <img class="card-img-top"
                                                    ...
                                                    alt="Title" />
                                                <div class="position-absolute top-0 end-0 mt-1 me-1">
                                                    <button class="badge bg-danger">Hết Hàng !</button>
                                                </div>
                                                ...
                                                <div class="position-absolute bottom-0 end-0 mb-1 me-0">
                                                    ...
                                                    <a class="btn favorite-button" data-product-id="4" ><i class='bx bx-heart fs-2'
                                                        title="Yêu thích"></i></a>
