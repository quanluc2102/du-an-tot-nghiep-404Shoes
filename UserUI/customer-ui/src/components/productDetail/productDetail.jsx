    ...
    return (
        <Fragment>
            <body>
                ...
                <main style={{ minHeight: '100vh', backgroundColor:'rgb(255, 228, 196)' }} data-bs-spy="scroll"
                    ...
                    <div className="content trang2 " id="div1">
                        <div className="row container">
                            <div className="col-7 content-left">
                                ...
                                <div className="mb-3">
                                    <img src="/imgs/shoe-banner (1).jpg" className="anh-to w-100" id="product-image" alt="ảnh sản phẩm" />
                            ...
                            <div className="col-5 content-right">
                                ...
                                <div className="row">
                                    <div className="col-6"> <span>Mã sản spanhẩm: *0998s</span></div>
                                    <div className="col-6"> <span>Tình trạng: Như Vừa Rời Xưởng</span></div>
                                    <div className="col-6"> <span>Hãng: Bán CaS</span></div>
                                    <div className="col-6"> <span>Dòng: Như Vừa Rời Xưởng</span></div>
                                </div>
                                <div className="row">
                                    <div className="col-12"><br />
                                        <h3><strong style={{ color: 'orangered' }}>124.121.000 VND</strong></h3>
                                    </div>
                                ...
                                <div className="row ">
                                    ...
                                    <div className="col-6">
                                        <div className="form-floating mb-3 border-0">
                                            <input type="number" min="0" className="form-control" name="formId1" id="formId1"
                                ...
                                <div className="row">
                                    ...
                                    <div className="col-2  ">
                                        <a className="btn favorite-button " title="Yêu  thích" data-product-id="1"><i
                                            class='bx bx-heart fs-2' title="Yêu thích"></i></a>
                                    </div>
                                    ...
                                    <div className="card text-start ">
                                        <div className="position-relative">
                                            ...
                                            <div className="position-absolute bottom-0 end-0 mb-1 me-0">
                                                ...
                                                <a className="btn favorite-button" data-product-id="1"><i class='bx bx-heart fs-2'
                                                    title="Yêu thích"></i></a>
                                    ...
                                    <div className="card text-start ">
                                        <div className="position-relative">
                                            ...
                                            <div className="position-absolute bottom-0 end-0 mb-1 me-0">
                                                ...
                                                <a className="btn favorite-button" data-product-id="2"><i class='bx bx-heart fs-2'
                                                    title="Yêu thích"></i></a>
                                    ...
                                    <div className="card text-start ">
                                        <div className="position-relative">
                                            ...
                                            <div className="position-absolute bottom-0 end-0 mb-1 me-0">
                                                ...
                                                <a className="btn favorite-button" data-product-id="3"><i class='bx bx-heart fs-2'
                                                    title="Yêu thích"></i></a>
                                    ...
                                    <div className="card text-start ">
                                        <div className="position-relative">
                                            ...
                                            <div className="position-absolute bottom-0 end-0 mb-1 me-0">
                                                ...
                                                <a className="btn favorite-button" data-product-id="4"><i class='bx bx-heart fs-2'
                                                    title="Yêu thích"></i></a>
