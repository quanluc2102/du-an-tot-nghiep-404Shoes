...
INSERT INTO san_pham (ngay_tao, gia_nhap, ten, gia_ban, so_luong, trang_thai, ngay_cap_nhat, mo_ta,giam_gia)
VALUES
  (GETDATE(), 100, 'Sản phẩm 1', 200, 10, 1, GETDATE(), 'Mô tả sản phẩm 1',175),
  (GETDATE(), 150, 'Sản phẩm 2', 250, 15, 1, GETDATE(), 'Mô tả sản phẩm 2',225),
  (GETDATE(), 200, 'Sản phẩm 3', 300, 20, 1, GETDATE(), 'Mô tả sản phẩm 3',275),
  (GETDATE(), 250, 'Sản phẩm 4', 350, 25, 1, GETDATE(), 'Mô tả sản phẩm 4',325),
  (GETDATE(), 300, 'Sản phẩm 5', 400, 30, 1, GETDATE(), 'Mô tả sản phẩm 5',375);
...
VALUES
  ...
  (5, 1, 4, 4, 4),
  (6, 1, 5, 5, 5);
  INSERT INTO hoa_don (ngay_tao, ghi_chu, ngay_cap_nhat, trang_thai, tai_khoan_id, thanh_toan_id,kieu_hoa_don,tong_tien,ten,sdt,email,thanh_pho,quan_huyen,phuong_xa)
VALUES
  (GETDATE(), 'Ghi chú 1', GETDATE(), 1, 1, 1,1,0,'TEN 1','0362460679','thieutttt01@gmail.com','Hà Lội','Đông Anh','Vân NộI'),
  (GETDATE(), 'Ghi chú 2', GETDATE(), 1, 2, 2,1,0,'TEN 2','0362460679','thieutttt02@gmail.com','Hà Lội','Đông Anh','Vân NộI'),
  (GETDATE(), 'Ghi chú 3', GETDATE(), 1, 3, 3,1,0,'TEN 3','0362460679','thieutttt03@gmail.com','Hà Lội','Đông Anh','Vân NộI'),
  (GETDATE(), 'Ghi chú 4', GETDATE(), 1, 4, 4,1,0,'TEN 4','0362460679','thieutttt04@gmail.com','Hà Lội','Đông Anh','Vân NộI'),
  (GETDATE(), 'Ghi chú 5', GETDATE(), 1, 5, 5,1,0,'TEN 5','0362460679','thieutttt05@gmail.com','Hà Lội','Đông Anh','Vân NộI');
...
INSERT INTO [dbo].[lich_su_hoa_don]
           ([ma_hoa_don],[san_pham],[phuong_thuc_thanh_toan],[nguoi_nhan],[khuyen_mai],[ngay_tao_hoa_don],[tong_tien],[dia_chi_giao],[ghi_chu],[trang_thai_hoa_don])
     VALUES
