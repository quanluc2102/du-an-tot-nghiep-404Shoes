...
class SanPhamDanhMucComponent extends Component {
    ...
    detail(id) {
        window.location.href = (`/sanphamdanhmucdetail/${id}`);
    }
                                    ...
                                    <div className="tab-content pt-2" id="myTabContent">
                                        <div className="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                                            <form>
                                                <div>
                                                    Tên :
                                                    <input className="form-control" name="sanPhamId" value={this.state.sanPhamDanhMucUpdate.sanPhamId} onChange={this.thayDoiSanPhamIdUpdate} />
                                                </div>
                                                <div className='form-group'>
                                                    <label>Sản phẩm</label>
                                                    <div className='form-group'>
                                                        <label>Sản phẩm</label>
                                                        <select name="sanPhamId" className="form-control" onChange={this.thayDoiSanPhamIdUpdate}>
                                                            <option value="">Chọn Sản phẩm</option>
                                                            {this.state.sanPhamDanhMuc.map((dmsp) => (
                                                                <option key={dmsp.sanPham.id} value={dmsp.sanPham.id} title={dmsp.sanPham.moTa}>
                                                                    {dmsp.sanPham.ten}
                                                                </option>
                                                            ))}
                                                        </select>
                                                ...
                                                <div className='form-group'>
                                                    ...
                                                    <select name="danhMucId" value={this.state.sanPhamDanhMucUpdate.danhMucId} className="form-control" onChange={this.thayDoiDanhMucIdUpdate}>
                                                        ...
                                                        {this.state.sanPhamDanhMuc.map((dmsp) => (
                                                            <option key={dmsp.danhMuc.id} value={dmsp.danhMuc.id}>
                                                                {dmsp.danhMuc.ten}
                                                            </option>
                                                        ))}
                                                    </select>
