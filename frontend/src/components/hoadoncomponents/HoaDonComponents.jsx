...
class HoaDonComponents extends Component {
    ...
    this.setState({ isButtonHidden: !this.state.isButtonHidden });
  };    
    handleSearch = (event) => {
                                                        ...
                                                        currentHoaDonList.map(
                                                            (hoaDon, index) =>
                                                                <tr key={hoaDon.id}>
                                                                    ...
                                                                    <td>{hoaDon.taiKhoanKhachHang && hoaDon.taiKhoanKhachHang.thongTinNguoiDung ? hoaDon.taiKhoanKhachHang.thongTinNguoiDung.ten : "Khách lẻ"}</td>
                                                                    <td>{hoaDon.taiKhoanKhachHang && hoaDon.taiKhoanKhachHang.thongTinNguoiDung ? hoaDon.taiKhoanKhachHang.thongTinNguoiDung.ten : "Khách lẻ"}</td>
                                                                    ...
                                                                    <td>{hoaDon.ghiChu}</td>
                                                                    <td>{hoaDon.tongTien !== null && hoaDon.tongTien !== undefined ? (hoaDon.tongTienSauGiam + hoaDon.phiShip).toLocaleString() : 'N/A'}</td>
