...
class TaiKhoanQuanLyComponent extends Component {
    constructor(props) {
        super(props);
        this.state = {
            nhanVienQuyen2: [],
    ...
    componentDidMount() {
        taikhoanservice.getQuanLy().then((res) => {
            this.setState({nhanVienQuyen2: res.data});
        });
...
//         }
        ...
        taikhoanservice.addQuanLy(requestData)
            .then((res) => {
                if (res.status=== 200) {
...
export default TaiKhoanQuanLyComponent